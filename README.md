...
**ヘルスチェック＋フィールド一覧＋ビュー一覧 for kintone Developers**
---
...
| API                       | 用途                                      |
| ------------------------- | --------------------------------------- |
| `/k/v1/app/form/fields`   | フィールド定義（必須・初期値・型など）／**コード→ラベル置換用マップ**作成 |
...
| Version   | Date       | 内容                                                                      |
| --------- | ---------- | ----------------------------------------------------------------------- |
| 1.0.0     | 2025-10-08 | 初版公開（Health + Fields 統合版）                                               |
| 1.1.0     | 2025-10-09 | フィールド名とコードが不一致の行をハイライト                                                  |
| 1.2.0 | 2025-10-11 | **Views タブ**を追加：一覧ビューの**可読化（ラベル置換）**／**Markdown/CSV 出力**／**デフォルトビュー表示** |
